...
const Amazon = () => {
	const products = [
		...
		},
		{
			...
			name: "Electric Glass and Steel Hot Tear",
			rating: {
				stars: 3.0,
				count: 846,
			},
		...
		},
		{
			...
			image: "https://m.media-amazon.com/images/I/611JV9lYD9L.jpg",
	...
	return (
		<div className="contaner">
			{products.map((item) => (
				<div className="coneiner" key={item.id}>
					<img className="imgFoto" src={item.image} alt="logo" />
					<p className="name">{item.name}</p>
					<p className="price"> ${item.priceCents}</p>
					<img className="foto" src={ratingImages[item.rating.stars]} alt="#" />
          <br />
